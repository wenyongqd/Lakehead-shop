<template>
	...
	class="fixed-bottom flex align-center border-top bg-white">
		...
		<input type="text" v-model="content" placeholder="say something..." class="flex-1 rounded bg-light ml-2" style="padding: 5rpx;" :focus="focus" @confirm="submit" @blur="$emit('blur')"/>
